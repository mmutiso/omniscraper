...
namespace Omniscraper.Core.Migrations
{
    ...
    [Migration("20230103123058_AddFlaggedColumnToVideos")]
    partial class AddFlaggedColumnToVideos
    {
            ...
            modelBuilder.Entity("Omniscraper.Core.Storage.VideoTag", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 1, 3, 12, 30, 58, 623, DateTimeKind.Utc).AddTicks(5974))
