...
namespace Omniscraper.Core.Migrations
{
    ...
    [Migration("20230223123243_UpdateNullableFields")]
            ...
            modelBuilder.Entity("Omniscraper.Core.Storage.FlagRequest", b =>
                {
                    ...
                    b.Property<string>("FlaggingReason")
                        .HasColumnType("longtext")
                        .HasColumnName("flagging_reason");
            ...
            modelBuilder.Entity("Omniscraper.Core.Storage.VideoTag", b =>
                {
                    ...
                    b.Property<DateTime>("DateCreated")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime(6)")
                        .HasDefaultValue(new DateTime(2023, 2, 23, 12, 32, 43, 526, DateTimeKind.Utc).AddTicks(6660))
            ...
            modelBuilder.Entity("TwitterVideoVideoTag", b =>
                {
                    b.HasOne("Omniscraper.Core.Storage.TwitterVideo", null)
                        ...
                        .IsRequired()
                        .HasConstraintName("fk_twitter_videos_video_tags_twitter_videos_twitter_videos_id");
